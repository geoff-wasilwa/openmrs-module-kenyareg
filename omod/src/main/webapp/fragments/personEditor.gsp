<%
    ...
    def fieldDefinitions = [
        ...
        [ formFieldName: "fathersFirstName", label : "Father's Fist Name", class : java.lang.String, id : "fathersFirstName" ],
        ...
        [ formFieldName: "mothersFirstName", label : "Mother's Fist Name", class : java.lang.String, id : "mothersFirstName" ],
    ...
    def conflictedPersonProperties = []
    conflictedProperties.each { property, lpiMpiValue ->
        ...
        if (definition) {
            ...
            conflictedPersonProperties.push(conflictedPair);
        }
    }
    def conflicatedFields = conflictedPersonProperties
%>

<form id="basic-search-form" method="post" action="${ui.actionLink("kenyareg", "personEditor", "update")}">
  ...
  jQuery(function(){
    jQuery(".resolve").on("change", function(){
      ...
      if (jQuery(this).is(":checked") && fieldName.indexOf("lpi") > 0) {
        ...
        jQuery("input[name=" + resolvedFieldName + "]")
